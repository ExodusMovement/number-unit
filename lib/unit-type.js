...
var UnitType = (function () {
  ...
  _createClass(UnitType, [{
    ...
    value: function _applyDefinitions(defaultUnit) {
      var _this = this;

      this.units = {};

      Object.keys(this.definitions).forEach(function (key) {
        _this.units[key] = Unit.create(_this, key, _this.definitions[key]);
    ...
    key: 'ZERO',
    get: function get() {
      return _numberUnit2['default'].create(0, this.defaultUnit);
    }
  }]);
