...
function conversion(numberUnit1, numberUnit2) {
  ...
  var converter = function converter(someNumberUnit) {
    ...
    if (ut === ut1) {
      ...
      var _normalizeNum = someNumberUnit.to(numberUnit2.unitName);
      var _newNumber = _normalizeNum._number.times(numberUnit1._number).div(numberUnit2._number);
      return ut1[numberUnit1.unitName](_newNumber);
    }
  };
